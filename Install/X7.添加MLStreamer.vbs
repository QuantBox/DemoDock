...
' 找到Providers节点
Set Providers = xmlDoc.selectSingleNode("/Configuration/Streamers")

Set WshShell = WScript.CreateObject("WScript.Shell")

' 找到Provider节点
Set Providers_Provider = xmlDoc.selectSingleNode("/Configuration/Streamers/Streamer[TypeName='MenuLoader.MLStreamer, MenuLoader']")
...
Sub AddNode(parent)  
	...
	Child1.Text = "MenuLoader.MLStreamer, MenuLoader"
	Set Child2 = xmlDoc.createElement("X64")
	Child2.Text = "true"
	Set Child0 = xmlDoc.createElement("Streamer")
